...
import { changePasswordSchema, type ChangePasswordFormData } from "@/validators/auth.validator";
...
export function ChangePasswordDialog({ open, onClose }: ChangePasswordDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      {/* Thay sm:max-w-106.25 thành class width an toàn sm:max-w-[425px] */}
      <DialogContent className="sm:max-w-106.25 bg-[#101010] text-[#f3f3f3] border-[#2a2a2a]">
        <DialogHeader>
          ...
          <DialogDescription className="text-[#777] text-sm pt-1">
            Nhập mật khẩu cũ và mật khẩu mới để tăng cường bảo mật cho tài khoản của bạn.
          </DialogDescription>
        </DialogHeader>
